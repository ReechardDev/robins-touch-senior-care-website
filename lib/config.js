export const SITE = {
  ...
  areas: ["Denver", "Aurora", "Lakewood", "Littleton", "Arvada", "Englewood", "Westminster"],

  pricingNote: "Simple rates. No long contracts.",

  // Used on the Home pricing strip (compact cards)
  plans: [
    {
      name: "Standard",
